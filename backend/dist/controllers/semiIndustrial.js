...
exports.getCasConditioners = exports.getDuctConditioners = exports.getColConditioners = void 0;
...
function getDuctConditioners(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
            const { items } = yield config_1.client.getEntries({
...
exports.getDuctConditioners = getDuctConditioners;
function getCasConditioners(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
            const { items } = yield config_1.client.getEntries({
...
exports.getCasConditioners = getCasConditioners;
